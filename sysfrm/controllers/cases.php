...
<div class="modal-footer">
    ...
    case 'add':
        ...
        $d = ORM::for_table('crm_accounts')->find_many();
        $ui->assign('d', $d);
        $ui->assign('xheader', '
...
<script type="text/javascript" src="' . $_theme . '/lib/add-case.js"></script>
    ...
    case 'add-post':
     ...
     //   $type = _post('type');
        ...
        if($msg == ''){
            ...
            $d = ORM::for_table('sys_cases')->create();
            $d->title = $title;
            $d->status = $status;
...
');
 ...
 ');
    ...
    case 'list':
        $type = $routes['2'];
        if($type == 'opened'){
            $paginator = Paginator::bootstrap('sys_cases','status','Product');
            ...
            $ui->assign('xfooter', '
<script type="text/javascript" src="' . $_theme . '/lib/cases-list.js"></script>
');
            $ui->display('cases-list.tpl');
        }

...
$ui->assign('xheader', '
<link href="ui/lib/c3/c3.min.css" rel="stylesheet" type="text/css">
');

$ui->assign('xfooter', '
<script type="text/javascript" src="ui/lib/jslib/dashboard-alt.js"></script>
<script type="text/javascript" src="ui/lib/c3/d3.min.js"></script>
<script type="text/javascript" src="ui/lib/c3/c3.min.js"></script>
...
var chart = c3.generate({
	...
	columns: [
		...
		[\'Income\', \'0\','.$d1i.','.$d2i.', '.$d3i.', '.$d4i.', '.$d5i.', '.$d6i.', '.$d7i.', '.$d8i.', '.$d9i.', '.$d10i.', '.$d11i.', '.$d12i.', '.$d13i.', '.$d14i.', '.$d15i.', '.$d16i.', '.$d17i.', '.$d18i.', '.$d19i.', '.$d20i.', '.$d21i.', '.$d22i.', '.$d23i.', '.$d24i.', '.$d25i.', '.$d26i.', '.$d27i.', '.$d28i.', '.$d29i.', '.$d30i.', '.$d31i.'],
		[\'Expense\', \'0\','.$d1e.','.$d2e.', '.$d3e.', '.$d4e.', '.$d5e.', '.$d6e.', '.$d7e.', '.$d8e.', '.$d9e.', '.$d10e.', '.$d11e.', '.$d12e.', '.$d13e.', '.$d14e.', '.$d15e.', '.$d16e.', '.$d17e.', '.$d18e.', '.$d19e.', '.$d20e.', '.$d21e.', '.$d22e.', '.$d23e.', '.$d24e.', '.$d25e.', '.$d26e.', '.$d27e.', '.$d28e.', '.$d29e.', '.$d30e.', '.$d31e.']
	],
        type: \'area-spline\',
         colors: {
            Income: \'#23c6c8\',
        ...
        bootbox.prompt({
            ...
            callback: function(result) {
                if (result === null) {
                   ...
                   // alert(result);
                     $.post( "index.php?_route=settings/networth_goal", { goal: result })
        .done(function( data ) {
            location.reload();
        });
                }
